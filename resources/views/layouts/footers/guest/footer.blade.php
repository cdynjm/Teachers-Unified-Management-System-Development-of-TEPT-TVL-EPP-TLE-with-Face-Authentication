        ...
        <div class="row mt-2">
          ...
          <div class="col-lg-4 col-sm-12 mb-4">
            <div class="row">
              ...
              <div class="col-lg-3 col-sm-3 col-md-3 col-xs-3"><a target = "_blank" href="https://www.deped.gov.ph/"><img class = "mt-2 img-fluid rounded-circle" src = "{{asset('/storage/images/deped-logo.png')}}" style = "width: 100px"></a></div>

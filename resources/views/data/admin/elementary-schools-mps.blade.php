    ...
    <tbody>
       ...
       @foreach ($subjects as $index => $sub)
           <tr>
               ...
               >
                   <a wire:navigate href="{{ route('admin.promeds', ['id' => $aes->encrypt($sub->id), 'type' => 0, 'type2' => 0, 'schoolType' => 1]) }}" class="ms-3 text-sm fw-bolder mb-0">{{ $sub->ElementarySubjects->subject }}</a>
               </td>

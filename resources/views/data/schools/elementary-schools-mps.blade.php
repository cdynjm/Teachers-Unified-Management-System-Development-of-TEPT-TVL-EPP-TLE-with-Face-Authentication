<table class="table align-items-center mb-0" id="elementary-school-mps-data-result">
    ...
    <tbody>
       ...
       <tr>
           ...
           >
            <a href="javascript:;" id="edit-elementary-total-students" class="text-secondary font-weight-bold text-xs me-2"
                data-toggle="tooltip">
       ...
       @foreach ($subjects as $index => $sub)
           <tr>
               ...
               >
                   <p class="ms-3 text-sm fw-bolder mb-0">{{ $sub->ElementarySubjects->subject }}</p>
               </td>
               <td class="text-start">
               ...
               <td class="text-center">
                   <a href="javascript:;" id="edit-elementary-subject-mps" class="text-secondary font-weight-bold text-xs me-2"
                       data-toggle="tooltip">
                       <i class="fas fa-pen-alt text-sm"></i>
                   </a>
               </td>

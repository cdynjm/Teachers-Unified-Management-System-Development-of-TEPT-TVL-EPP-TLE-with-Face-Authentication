<!-- The Modal -->
<div class="modal fade" id="viewHighSchoolModal" aria-hidden="true" style="display: none;">
        ...
        <div class="modal-content border-radius-md">
            ...
            <div class="modal-body">
                ...
                <form action="" id="search-high-school">
                    <input type="hidden" id="high-school-id" name="school">
                    <input type="hidden" id="high-school-year" name="year">
                ...
                <form action="" id="search-high-school-teachers">
                    <input type="hidden" id="high-school-teachers-id" name="school">
                ...
                <a wire:navigate href="{{ route('school-documents', ['school' => ':id', 'type' => '2']) }}" class="bg-white border-0 text-sm mb-2 ms-1" id="high-school-documents-link">
